...
#define CONFIGURE_ARGS " '--prefix=/Users/jack/Documents/postgresql-18.4/build/' '--without-icu' 'LDFLAGS=-L/usr/local/opt/ruby/lib' 'CPPFLAGS=-I/usr/local/opt/ruby/include' 'PKG_CONFIG_PATH=/usr/local/opt/ruby/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 18.4 on x86_64-apple-darwin21.6.0, compiled by Apple clang version 14.0.0 (clang-1400.0.29.202), 64-bit"
