...
#define CONFIGURE_ARGS " '--prefix=/root/opens/postgresql-18.4/build/'"
...
#define PG_VERSION_STR "PostgreSQL 18.4 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 16.1.1 20260625, 64-bit"
